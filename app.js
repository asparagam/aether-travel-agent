            ...
            return `
              <div class="option-item ${isSelected ? 'selected' : ''}">
                <div class="option-details">
                  <span class="option-name">${fl.airline} (${fl.flightNo})</span>
                  <div class="option-sub">
                    <span>${fl.departure}</span>
                ...
                <div class="option-actions">
                  ...
                  <button class="btn-add-option" onclick="selectFlight('${fl.id}')">
            ...
            return `
              <div class="option-item ${isSelected ? 'selected' : ''}">
                <div class="option-details">
                  ...
                  <div class="option-sub">
                    <span style="color:#eab308;">${'★'.repeat(ht.stars)}</span>
                    <span class="divider"></span>
                    <span>Rating ${ht.rating}</span>
                  </div>
                </div>
                <div class="option-actions">
                  <span class="option-price">$${ht.pricePerNight} <span>/night</span></span>
                  <button class="btn-add-option" onclick="selectHotel('${ht.id}')">
...
// Add Options to Itinerary State
function selectFlight(flightId) {
  ...
  selectDestination(state.selectedDestination.id); // re-render detail view to update button state
  addBotMessage(`✈️ Added flight <strong>${flight.airline} (${flight.flightNo})</strong> to your itinerary.`);
...
function selectHotel(hotelId) {
  ...
  selectDestination(state.selectedDestination.id); // re-render detail view
